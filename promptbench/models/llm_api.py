...
class LLMAPI:
    """`LLMAPI` is a base object of calling API LLM."""
    ...
    async def predict(self, messages, params: List[dict], format_output: str = "TEXT", **kwargs):
        try:
            ...
            logging.info(f"[LLMAPI][ERROR] Request API ERROR: {traceback.format_exc()}")
            return None
